...
const API_ROUTES = {
  ...
  GROUP: {
    ...
    UPDATE: (groupId: string) => `v1/groups/${groupId}`,
    JOIN: (groupId: string) => `v1/groups/${groupId}/join`,
    UPDATE_VISIBILITY: (groupId: string) => `v1/groups/${groupId}/visibility`,
    DELETE: (groupId: string) => `v1/groups/${groupId}`,
    TRANSFER_OWNERSHIP: (groupId: string) =>
      `v1/groups/${groupId}/transfer-ownership`,
    ADD_MEMBERS: (groupId: string) => `v1/groups/${groupId}/add-members`,
    GET_MEMBERS: (groupId: string) => `v1/groups/${groupId}/members`,
    DELETE_MEMBER: (groupId: string, memberId: string) =>
      `v1/groups/${groupId}/delete-member/${memberId}`,
    CHANGE_ROLE: (groupId: string, memberId: string) =>
      `v1/groups/${groupId}/change-role/${memberId}`,
    UPDATE_ROLE_PERMISSION: (groupId: string) =>
      `v1/groups/${groupId}/role-permissions`,
    GET_MESSAGES: (groupId: string) => `v1/groups/${groupId}/messages`,
    LEAVE: (groupId: string) => `v1/groups/${groupId}/leave`,
    GET_AVAILABLE_PERMISSIONS: "v1/groups/permissions",
  },
  MESSAGE: {
  ...
  BLOG: {
    ...
    ADD_COMMENT: (id: string) => `v1/blogs/${id}/comment`,
  ...
  VOCABULARY: {
    ...
    IMPORT_ANKI: "v1/vocabulary/collections/import/anki",
